          ...
          {!fetchBotQuery.isLoading ? (
            <div className="py-4">
              ...
              <div className="pb-8">
                ...
                <div className="mt-1">
                  <textarea
                    ...
                    conversation with. Your name is &quot;AI Assistant&quot;.
                    You will provide me with answers from the given info. If the
              ...
              <div className="pb-8">
                ...
                <p className="mt-2 text-sm text-zinc-500">
                  &apos;Private but can be embedded on website&apos;: Other
                  people can&apos;t access your chatbot if you send them the
                  link, but you can still embed it on your website and your
                  website visitors will be able to use it. (make sure to set
                  your domains)
                </p>
                <p className="mt-2 text-sm text-zinc-500">
