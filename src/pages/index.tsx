        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex items-center space-x-4 lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <span className="text-xl">Chatbase Co</span>
          </div>
        ...
        <div className="relative px-6 lg:px-8 py-16 sm:py-8">
          ...
          <div className="text-center w-[38rem]">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Custom ChatGPT for <span className='text-transparent bg-clip-text bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] from-purple-200 via-violet-700 to-rose-700'>your website</span> 
            </h1>
